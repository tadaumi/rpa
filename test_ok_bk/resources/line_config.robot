...
${START_TIMEOUT}                 30
${GROUP_ITEM_PATH}               path:11|2|1|1|1|3
...
${COPY_PROBE_IMAGE_FILE}         ${ARTIFACT_IMAGE_DIR}${/}copy_probe_capture.png
${COPY_PROBE_TEXT_FILE}          ${ARTIFACT_TEXT_DIR}${/}copy_probe_capture.txt
...
# DX/DY は固定。probe の切り出しサイズだけ調整
${COPY_PROBE_MARGIN_X}           32
${COPY_PROBE_MARGIN_Y}           10
${COPY_PROBE_W}                  110
${COPY_PROBE_H}                  28
${COPY_PROBE_WAIT_MS}            1500ms
